...
#[test]
fn bindgen_test_layout_MenuItem() {
    const UNINIT: ::std::mem::MaybeUninit<MenuItem> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<MenuItem>(),
        32usize,
        concat!("Size of: ", stringify!(MenuItem))
    );
    assert_eq!(
        ::std::mem::align_of::<MenuItem>(),
        8usize,
        concat!("Alignment of ", stringify!(MenuItem))
    );
    assert_eq!(
