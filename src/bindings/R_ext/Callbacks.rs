...
#[test]
fn bindgen_test_layout__ToplevelCallback() {
    const UNINIT: ::std::mem::MaybeUninit<_ToplevelCallback> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_ToplevelCallback>(),
        40usize,
        concat!("Size of: ", stringify!(_ToplevelCallback))
    );
    assert_eq!(
        ::std::mem::align_of::<_ToplevelCallback>(),
        8usize,
        concat!("Alignment of ", stringify!(_ToplevelCallback))
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout__R_ObjectTable() {
    const UNINIT: ::std::mem::MaybeUninit<_R_ObjectTable> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_R_ObjectTable>(),
        96usize,
        concat!("Size of: ", stringify!(_R_ObjectTable))
    );
    assert_eq!(
        ::std::mem::align_of::<_R_ObjectTable>(),
        8usize,
        concat!("Alignment of ", stringify!(_R_ObjectTable))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).type_) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_R_ObjectTable),
            "::",
            stringify!(type_)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cachedNames) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(_R_ObjectTable),
            "::",
            stringify!(cachedNames)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).canCache) as usize - ptr as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(_R_ObjectTable),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).onDetach) as usize - ptr as usize },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(_R_ObjectTable),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).onAttach) as usize - ptr as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(_R_ObjectTable),
